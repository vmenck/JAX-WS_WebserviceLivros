...
public class RepositoryLivros {
	...
	private static void loadLivros()
	{
		...
		l1.setAutores(Arrays.asList(new Autor("Sun Tzu")));
		l1.setEditora("");
		...
		l2.setAutores(Arrays.asList(new Autor("Hunter, James C")));
		l2.setEditora("");
		l2.setResumo("“");
		...
		l3.setAutores(Arrays.asList(new Autor("Hunter, James C")));
		l3.setEditora("");
		...
		l4.setAutores(Arrays.asList(new Autor("Eker, T. Harv")));
		l4.setResumo("“");
		...
		l5.setAutores(Arrays.asList(new Autor("Barbosa, Christian")));
		l5.setEditora("");
		l5.setResumo("“");
		...
		l6.setAutores(Arrays.asList(new Autor("Moritz, Michael"), new Autor("Assistente 1")));
		l6.setEditora("");
		l6.setResumo("“");
		...
		l7.setAutores(Arrays.asList(new Autor("Guillebeau, Chris"), new Autor("Assistente 1"),new Autor("Assistente 2"),new Autor("Assistente 3")));
		l7.setEditora("");
		l7.setResumo("“");
		...
		l8.setAutores(Arrays.asList(new Autor("C.S. Lewis")));
		l8.setEditora("WMF");
		l8.setResumo("");
		...
		l9.setAutores(Arrays.asList(new Autor("J.R.R. Tolkein")));
		l9.setEditora("WMF");
		l9.setResumo("Epic!");
		...
		l10.setAutores(Arrays.asList(new Autor("Alexandre Saudate")));
